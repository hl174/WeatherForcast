...
public class Utility {
	...
	public synchronized static boolean handleProvincesResponse(
			WeatherForcastDB weatherForcastDB, String response) {
	...
	public static boolean handleCitiesResponse(
			WeatherForcastDB weatherForcastDB, String response, int provinceId) {
		if (!TextUtils.isEmpty(response)) {
	...
	public static boolean handleCountiesResponse(
			WeatherForcastDB weatherForcastDB, String response, int cityId) {
		if (!TextUtils.isEmpty(response)) {
